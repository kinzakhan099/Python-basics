...
class Teacher(Person):
    def __init__(self, name, teacher_id, login_system):
...
def main():
    ...
    while True:
        ...
        while True:
            ...
            continue  # Inner loop did not break manually

        # Role initialization
        if role == "student":
            user = Student(name, person_id, login_sys, record_sys)
        elif role == "teacher":
            user = Teacher(name, person_id, login_sys)
        elif role == "ta":
